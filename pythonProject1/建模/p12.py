...
# 准备特征
features = ['电磁辐射 (EMR)', 'EMR_mean', 'EMR_std', 'max_frequency', 'max_amplitude'] + [f'wt_mean_{i}' for i in range(2)] + [f'wt_std_{i}' for i in range(2)] + [f'wt_max_{i}' for i in range(2)] + [f'wt_min_{i}' for i in range(2)]
X = data[features]
